...
namespace UnitTests
{
    public class RestaurantBranchServiceTest
    {
        ...
        public void GetFiveNearestBranches_ShouldReturnRestaurantBranchDtoList(double latitude, double longitude)
        {
            ...
            mockRepository.Setup(x => x.GetAllBranches()).ReturnsAsync(restaurantBranches);
            ...
            mockMapper.Setup(x => x.Map<List<RestaurantBranchDto>>(restaurantBranches)).Returns(restaurantBranchDtos);
